...
train_data_gen = train_data_generator(16)
...
deconv4 = Conv2DTranspose(12, 3, strides=8, activation='relu', padding='same')(conv4)
...
deconvs = concatenate([conv12, deconv2, deconv3, deconv4])
...
history = model.fit_generator(train_data_gen, epochs = 30, steps_per_epoch= 254, initial_epoch=20,
                                validation_data = (X_val, Y_val), verbose = 1)

model.save('keras_unet_320_480_30epochs.hd5')

model = load_model('keras_unet_320_480_30epochs.hd5',custom_objects={'dice_loss':dice_loss,'dice_coef':dice_coef})
