...
history = model.fit_generator(train_data_gen, epochs = 2, steps_per_epoch= 4088,initial_epoch=1,
                                validation_data = val_data_gen, validation_steps = 512,verbose = 1)

model.save('keras_unet_1280_1920_ensemble_final_new_1epochs.hd5')
print 'Model Saved!'
